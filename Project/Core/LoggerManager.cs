...
namespace log4net.Core
{
	...
	public sealed class LoggerManager
	{
		...
		/// </para>
		/// </remarks>
		public static bool Exists(string repositoryName)
		{
			return RepositorySelector.ExistsRepository(repositoryName);
		}
		...
		private static string GetVersionInfo()
		{
			...
			Assembly assembly = typeof(LoggerManager).GetTypeInfo().Assembly;
			stringBuilder.Append($"log4net assembly [{assembly.FullName}]. ");
			stringBuilder.Append($"(.NET Framework [{RuntimeInformation.FrameworkDescription}] on {RuntimeInformation.OSDescription}");
