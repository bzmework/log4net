...
namespace log4net.Util
{
	...
	public sealed class SystemInfo
	{
		...
		/// </para>
		/// </remarks>
		public static string ApplicationBaseDirectory => Directory.GetCurrentDirectory();
		...
		/// </para>
		/// </remarks>
		public static string ConfigurationFileLocation => EntryAssemblyLocation + ".config";
		...
		/// </para>
		/// </remarks>
		public static string EntryAssemblyLocation => AppContext.BaseDirectory;
		...
		{
			return type.FullName + ", " + type.GetTypeInfo().Assembly.FullName;
		}
		...
		{
			string text = AssemblyShortName(myAssembly);
			string fileNameWithoutExtension = Path.GetFileNameWithoutExtension(EntryAssemblyLocation);
			if (string.Compare(text, fileNameWithoutExtension, ignoreCase: true) == 0)
			{
				return text + ".exe";
			}
			return text + ".dll";
